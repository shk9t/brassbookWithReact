...
function SignUpSelfAcc({className}: SignFormBodyProps) {
        ...
        <form action="" className={"sign-form sign-in-form" + '' || className} onSubmit={(event) => onsubmitHandler(event)}>
            <div className="sign-form__fields-container">
                ...
                <div className="sign-form__field">
                    ...
                    <input name="RepeatPassword" id="RepeatPassword" placeholder="Повторите пароль" className="sign__input" type="password" onChange={(event) => passwordChangeHandler(event)}></input>
                </div>
            </div>
